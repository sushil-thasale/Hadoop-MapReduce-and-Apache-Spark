/*
 * CoareseLock_ProcessorThread extends thread class and computes average TMAX 
 * for the assigned load and stores it in centralized data structure "stationMap"
 */



public class CoarseLock_ProcessorThread extends Thread{
	 ...
	 */
	public CoarseLock_ProcessorThread(long start, long end, CentralData c)
	{
		this.start = start;
		this.end = end;
		this.c = c;
