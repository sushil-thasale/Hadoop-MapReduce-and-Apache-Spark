...
public class FineLockProcessing_Fibo {

	public void FineLockExecution_Fibo(CentralData c) throws Exception {

		final int totalCores 		= 8;	// threads to be spawned
		final String opFileName 	= "output/FineLockThreadOP_Fibo.txt";
		...
		for (int iteration = 0; iteration < 10; iteration++) {
			...
			ArrayList<FineLock_ProcessorThread_Fibo> pThreads = new ArrayList<FineLock_ProcessorThread_Fibo>();
			...
			for (int i = 0; i < totalCores; i++) {
				...
				pThreads.add(new FineLock_ProcessorThread_Fibo(startPos, endPos, c));
			}
