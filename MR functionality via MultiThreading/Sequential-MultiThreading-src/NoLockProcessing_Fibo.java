...
public class NoLockProcessing_Fibo {

	public void NoLockExecution_Fibo(CentralData c) throws Exception {

		final int totalCores 		= 8;	// threads to be spawned
		final String opFileName 	= "output/NoLockThreadOP_Fibo.txt";
		...
		for (int iteration = 0; iteration < 10; iteration++) {
			...
			ArrayList<NoLock_ProcessorThread_Fibo> pThreads = new ArrayList<NoLock_ProcessorThread_Fibo>();
			...
			for (int i = 0; i < totalCores; i++) {
				...
				pThreads.add(new NoLock_ProcessorThread_Fibo(startPos, endPos, c));
			}
