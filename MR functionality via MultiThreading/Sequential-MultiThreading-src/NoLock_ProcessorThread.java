/*
 * NoLock_ProcessorThread extends thread class and computes average TMAX 
 * for the assigned load and stores it in centralized data structure "stationMap"
 */



public class NoLock_ProcessorThread extends Thread{
	 ...
	 */
	public NoLock_ProcessorThread(long start, long end, CentralData c)
	{
		this.start = start;
		this.end = end;
		this.c = c;
